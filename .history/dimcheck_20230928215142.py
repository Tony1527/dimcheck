...
class Dimcheck:
    ...
    def _divide_file_path(self,path):
        dir_path,filename = self._split_dir_file(path)
...
si=Dimcheck(config_file="./si.json",is_save=False)
